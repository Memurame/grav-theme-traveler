...
const files = {
  ...
  js: {
    ...
    core: [
      ...
      path.src.core.js + 'jquery.lazy.min.js',
      path.src.core.js + 'lightslider.min.js'
    ]
  },
  scss: {
...
const dependencies = {
  scss: {
    ...
    lightslider: {
      base: path.src.core.scss + 'lightslider/',
      src: 'node_modules/lightslider/src/css/**/*',
      dest: path.src.core.scss + 'lightslider/'
    }
  },
  fonts: {
    fontawesome: {
  ...
  js : {
    ...
    lazy: {
      base: path.src.core.js + 'jquery.lazy.min.js',
      src: 'node_modules/jquery-lazy/jquery.lazy.min.js',
      dest: path.src.core.js
    },
    lightslider: {
      base: path.src.core.js + 'lightslider.min.js',
      src: 'node_modules/lightslider/dist/js/lightslider.min.js',
      dest: path.src.core.js
    },
    lightgallery: {
